...
class HttpAPI {
	...
	func createUrl(searchParam: SearchParam, searchTerm: String) -> URLRequest {
		return URLRequest(url: URL(string: "https://www.omdbapi.com/?\(searchParam.term)=\(searchTerm)&\(apiKey)")!, cachePolicy: .reloadIgnoringLocalCacheData, timeoutInterval: 300)
	}
